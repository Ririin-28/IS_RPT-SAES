...
export default function GradeOneTab({ reports, activeTab = "Grade 5", setActiveTab }: Props) {
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 gap-4">
        <div className="flex items-center gap-0">
          ...
          {setActiveTab ? (
            ...
            <span className="text-xl font-semibold text-[#013300] px-3 py-1.5 rounded-lg bg-[#013300]/5">Grade 5</span>
          )}
        </div>
