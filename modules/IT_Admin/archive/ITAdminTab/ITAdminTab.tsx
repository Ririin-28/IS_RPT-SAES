...
import ITAdminDetailsModal from "./ITAdminDetailsModal";
...
${lines.join("\n")}`,
  ...
  const handleViewDetails = useCallback((admin: any) => {
                ...
                <div className="py-1">
                  ...
                  <button
                    ...
                    className={`mt-1 flex w-full items-center gap-2 px-4 py-2 text-left text-sm ${
                      filteredAdmins.length === 0 ? "text-gray-300 cursor-not-allowed" : "text-[#013300] hover:bg-gray-50"
                    }`}
