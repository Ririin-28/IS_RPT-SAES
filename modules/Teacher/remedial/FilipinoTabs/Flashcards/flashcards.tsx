...
type FilipinoFlashcardsProps = ComponentProps<typeof FilipinoFlashcards>;
type StudentRecord = FilipinoFlashcardsProps["students"][number];
...
type StudentPerformanceEntry = FilipinoFlashcardsProps["performances"][number];
