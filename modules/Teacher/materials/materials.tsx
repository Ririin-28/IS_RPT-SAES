...
import { useTeacherMaterials } from "./useTeacherMaterials";
import ConfirmationModal from "@/components/Common/Modals/ConfirmationModal";
import MaterialGridModal from "../../MasterTeacher/RemedialTeacher/materials/MaterialGridModal";
...
export default function MasterTeacherMaterials() {
  ...
  // Integrate useTeacherMaterials for upload functionality
  const { uploadFiles, uploading } = useTeacherMaterials({
    subject,
    level: activeTab,
  });
  ...
  if (showInitialSkeleton) {
    return <TeacherPageSkeleton title="Materials" />;
  }
        ...
        <main className="flex-1 flex flex-col min-h-0 overflow-hidden p-4 sm:p-5 md:p-6">
            ...
            <div className="relative z-10 w-full h-full rounded-2xl border border-white/70 bg-white/45 shadow-[0_20px_45px_-28px_rgba(15,23,42,0.45)] backdrop-blur-xl flex flex-col overflow-hidden">
                ...
                <div className="flex-1 overflow-hidden flex flex-col relative">
                     {/* Inner Header for Schedule (Optional) */}
