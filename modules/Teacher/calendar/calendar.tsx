...
export default function TeacherCalendar() {
  ...
  return (
    <div className="teacher-calendar-page relative flex h-screen overflow-hidden bg-linear-to-br from-[#edf9f1] via-[#f5fbf7] to-[#e7f4ec]">
      ...
      <div className="relative z-10 flex-1 pt-16 flex flex-col overflow-hidden">
        ...
        <main className="flex-1 overflow-y-auto">
          <div className="teacher-calendar-scroll p-4 h-full sm:p-5 md:p-6">
            <div className="teacher-calendar-surface relative z-10 h-full min-h-100 overflow-y-auto rounded-2xl border border-white/70 bg-white/45 p-4 shadow-[0_20px_45px_-28px_rgba(15,23,42,0.45)] backdrop-blur-xl sm:p-5 md:p-6">
              {profileError && (
      ...
      <div className="print-calendar-document print-only">
        {printableMonths.map((item, monthIndex) => {
          ...
          const gradeTitle = normalizeGradeLabel(gradeFilter) ?? "Grade";

          return (
            <section className="print-month-page" key={item.key}>
              <header className="print-month-header">
                <h1 className="text-xl font-bold text-gray-900">{gradeTitle} Calendar</h1>
      ...
      <style jsx global>{`
        ...
        @media print {
          ...
          .teacher-calendar-page > :not(.print-calendar-document) {
            display: none !important;
          }
