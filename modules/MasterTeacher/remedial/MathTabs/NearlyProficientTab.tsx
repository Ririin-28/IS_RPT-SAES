...
export default function NearlyProficientTab() {
  ...
  return (
    <div>
      ...
      <TableList columns={[{key:"no",title:"No#"},{key:"title",title:"Title"},{key:"domain",title:"Domain"},{key:"dateToUse",title:"Date to use"},{key:"status",title:"Status"}]}
