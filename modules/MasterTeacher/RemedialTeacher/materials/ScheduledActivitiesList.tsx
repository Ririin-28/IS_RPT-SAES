...
type Props = {
  ...
  loading: boolean;
  error: string | null;
  onAttach: (activity: CalendarActivity) => void;
};
...
export default function ScheduledActivitiesList({ activities, subject, loading, error, onAttach }: Props) {
