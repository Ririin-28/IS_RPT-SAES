...
export default function ForgotPassword() {
	...
	return (
		<div className="min-h-screen text-[#013300] relative overflow-hidden scroll-smooth flex items-center justify-center md:py-8">
			{/* Background styling aligned with Login page */}
